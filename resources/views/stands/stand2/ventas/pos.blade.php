...
@section('title', 'Punto de Venta - Stand 2') {{-- 👈 Cambiar Título --}}
...
<div class="container mt-4">
    ...
    {{-- Volver al Dashboard --}}
    <div class="mb-3">
        {{-- 👈 Cambiar Ruta a stand2.dashboard --}}
    ...
    <div class="card shadow-sm border-light">
        ...
        <div class="card-body">
            ...
            {{-- Campo dinámico para cuotas (Sin cambios) --}}
...
(function() {
    ...
    // Cambiar la URL de la búsqueda
    async function buscarProductos(query) {
        const busquedaId = ++ultimaBusquedaId;
        
        try {
            // 👈 Cambiar la ruta de stand1 a stand2
    ...
    // Cambiar la URL de la búsqueda directa
    ...
    // ========== FUNCIÓN: AGREGAR/RENDERIZAR/ELIMINAR (sin cambios) ==========
    ...
    console.log('✅ POS inicializado correctamente (Stand 2)');
})();
</script>
@endsection