...
@section('title', 'Listado de Ventas - Stand 2')

@section('content')
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        <h1 class="fw-bold text-dark m-0">
            <i class="fas fa-receipt"></i> Listado de Ventas - Stand 2
        </h1>
        ...
        <div class="d-flex gap-2">
            ...
            {{-- ➕ Nueva Venta --}}
            <a href="{{ route('stands.stand2.ventas.pos') }}" 
    ...
    {{-- 🔍 FILTROS --}}
    <form id="formFiltros" method="GET" action="{{ route('stands.stand2.ventas.index') }}" class="card shadow-sm border-light mb-4">
        <div class="card-body">
            ...
            <div class="mt-3 d-flex justify-content-end">
                <a href="{{ route('stands.stand2.ventas.index') }}" 
                    ...
                    <tbody id="ventasBody">
                        @forelse ($ventas as $venta)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('stands.stand2.ventas.show', $venta->id) }}" 
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function buscarVentas(pageUrl = null) {
        ...
        const url = pageUrl ?? "{{ route('stands.stand2.ventas.index') }}";
