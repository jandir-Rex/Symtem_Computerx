...
@section('title', 'Detalle de Venta - Stand 1')
...
<div class="container py-4">
    ...
    <a href="{{ route('stands.stand1.ventas.index') }}" class="btn btn-outline-secondary mt-3">
...
<script>
    ...
    const rutaDescargar = "{{ route('stands.stand1.ventas.descargar-comprobante', ['id' => $venta->id]) }}";
    ...
    document.querySelectorAll('.btn-pagar').forEach(btn => {
        btn.addEventListener('click', async () => {
            ...
            try {
                const res = await fetch(`/stand1/ventas/cuota/${id}/pagar`, {
                    method: 'POST',
                    headers: {
